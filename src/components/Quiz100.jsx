...
// // ... (QUESTIONS, shuffle, Icons - נשארים ללא שינוי)
...
//   // ─── חדש: useEffect לטיפול בגלילה ──────────────────────────────────────────
//   useEffect(() => {
//     // 1. גלילה של חלון הדפדפן הראשי
//     window.scrollTo(0, 0);

//     // 2. גלילה של הדיב הספציפי (אם ה-CSS משתמש ב-Overflow על ה-screen)
//     const screenElements = document.querySelectorAll('.screen');
//     screenElements.forEach(el => {
//       el.scrollTop = 0;
//     });
    
//     // 3. טיפול ב-app-shell אם הוא זה שגולל
//     const shell = document.querySelector('.app-shell');
//     if (shell) shell.scrollTop = 0;
//   }, [screen, currentIndex]); // ירוץ בכל פעם שהמסך מתחלף או שהשאלה מתחלפת
//   // ───────────────────────────────────────────────────────────────────────────
...
//   const handleNext = () => {
//     // אין צורך ב-scrollToTop ידני כאן, ה-useEffect יטפל בזה כש-currentIndex ישתנה
//     if (isLastQuestion) {
//       const merged = { ...allAnswers, ...currentAttemptAnswers };
//       setAllAnswers(merged);
//       setScreen('results');
